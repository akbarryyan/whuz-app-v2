...
export default function InfoPage({
  ...
  return (
    <div className={`${quicksand.className} flex min-h-screen justify-center bg-[#F5F5F5]`}>
      <div className="relative w-full max-w-120 min-h-screen bg-[#F5F5F5] shadow-2xl flex flex-col overflow-x-hidden lg:max-w-none lg:bg-[#F5F5F5] lg:shadow-none">
        <AppHeader onBack={() => router.back()} />
        <div className="h-15" />

        {/* Desktop centered column */}
        <div className="flex-1 pb-24 lg:pb-12 lg:mx-auto lg:w-full lg:max-w-3xl">

          {/* Title bar */}
          <div className="bg-white px-4 py-3 border-b border-slate-100 lg:rounded-t-2xl lg:border lg:border-slate-200 lg:px-8 lg:py-4">
          ...
          {loading ? (
            ...
            <div className="bg-white px-4 py-5 lg:rounded-b-2xl lg:border lg:border-t-0 lg:border-slate-200 lg:px-8 lg:py-6">
              <article
            ...
            <div className="flex flex-col items-center justify-center pt-20 px-6 text-center lg:rounded-b-2xl lg:border lg:border-t-0 lg:border-slate-200 lg:bg-white lg:px-8 lg:py-20">
