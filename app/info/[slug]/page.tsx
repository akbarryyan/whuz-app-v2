    ...
    <div className={`${quicksand.className} flex min-h-screen justify-center bg-[#F5F5F5] lg:bg-[#F5F5F5]`}>
      <div className="relative w-full max-w-120 min-h-screen bg-[#F5F5F5] shadow-2xl flex flex-col lg:max-w-7xl lg:bg-[#F5F5F5] lg:shadow-none">
        ...
        <div className="bg-white px-4 py-3 border-b border-slate-100 lg:mx-auto lg:w-full lg:max-w-5xl lg:border-slate-200 lg:bg-white lg:px-6">
          <h1 className="text-base font-bold text-slate-800 lg:text-slate-800">{title}</h1>
        </div>
        ...
        <div className="flex-1 pb-24 lg:pb-12">
          {loading ? (
            ...
            <div className="bg-white px-4 py-5 lg:mx-auto lg:w-full lg:max-w-5xl lg:rounded-[28px] lg:border lg:border-slate-200 lg:bg-white lg:px-6 lg:py-6">
              <article
            ...
            <div className="flex flex-col items-center justify-center pt-20 px-6 text-center lg:mx-auto lg:w-full lg:max-w-5xl lg:rounded-[28px] lg:border lg:border-slate-200 lg:bg-white lg:px-8 lg:py-20">
              <div className="w-16 h-16 rounded-full bg-slate-100 flex items-center justify-center mb-4 lg:bg-slate-50">
              ...
              <p className="text-sm font-semibold text-slate-500 lg:text-slate-800">Belum ada konten</p>
